...
import { ListMedicalHomeRoutingModule } from './list-medical-home-routing.module';
...
@NgModule({
    ...
    declarations: [ListMedicalHomeComponent],
})
export class ListMedicalHomeModule {}
